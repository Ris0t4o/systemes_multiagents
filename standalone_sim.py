...
def update(frame):
    ...
    game_referee.update_catches(rmtt_poses, rmtt_states, cf2_poses, cf2_states,
    ...
    sim_viz.update(rmtt_poses, rmtt_states, cf2_poses, cf2_states, clock_time)
